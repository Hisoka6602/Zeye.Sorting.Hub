...
public sealed record WebRequestAuditLogDetailReadModel {
    ...
    /// 请求载荷类型。
    /// </summary>
    public required WebRequestPayloadType RequestPayloadType { get; init; }
    ...
    /// 响应载荷类型。
    /// </summary>
    public required WebResponsePayloadType ResponsePayloadType { get; init; }
    ...
    /// 审计资源类型。
    /// </summary>
    public required AuditResourceType AuditResourceType { get; init; }
    ...
    /// 文件操作类型。
    /// </summary>
    public required FileOperationType FileOperationType { get; init; }
