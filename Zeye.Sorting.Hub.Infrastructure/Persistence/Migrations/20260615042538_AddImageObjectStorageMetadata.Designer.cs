...
namespace Zeye.Sorting.Hub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260615042538_AddImageObjectStorageMetadata")]
    partial class AddImageObjectStorageMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zeye.Sorting.Hub.Domain.Aggregates.DataGovernance.ArchiveTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("CheckpointPayload")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Zeye.Sorting.Hub.Domain.Aggregates.Events.InboxMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Zeye.Sorting.Hub.Domain.Aggregates.Idempotency.IdempotencyRecord", b =>
                {
                    ...
                    b.HasIndex("SourceSystem", "OperationName", "BusinessKey", "PayloadHash")
                        .IsUnique();
                    ...
                    b.OwnsMany("Zeye.Sorting.Hub.Domain.Aggregates.Parcels.ValueObjects.ImageInfo", "ImageInfos", b1 =>
                        {
                            ...
                            b1.Property<long?>("ObjectSizeBytes")
                                .HasColumnType("bigint");
                            ...
                            b1.Property<int?>("StorageProvider")
                                .HasColumnType("int");
